...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@dotpp/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@dotpp/tui";
